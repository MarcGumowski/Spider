...
# Set Custom Union as Factor and assign them a lvl depending on the total average tariffs
# dbplot$Custom_Union_Code <- factor(dbplot$Custom_Union_Code, level = plotorder$Custom_Union_Code)
...
# Div Checboxes
cat("
<th style='text-align:left;vertical-align:top;' nowrap><div class='checkboxes'>", 
